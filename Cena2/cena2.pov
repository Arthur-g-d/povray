...
#include "../Base/vacaDourada.inc"     // Inclusão da vaca dourada

// Declaração de variável para deslocamento que varia com o tempo (clock)
#declare deslocamento = -clock*40;

//POSI��O DO FILHO
#declare posFilho1 = <-60, 5, 40 + deslocamento>;
#declare posFilho2 = <-60, 2, 31>;   

#declare rotFilho1 = <0, 0, 0>;
#declare rotFilho2 = <90, 0, 0>;

// Seleciona entre ir e voltar
#if (clock < 0.3)
  #declare posicao = posFilho1; 
  #declare rotacao = rotFilho1;
#else
  #declare posicao = posFilho2;
  #declare rotacao = rotFilho2;
#end

//POSI��O DO PAI
#declare posPai1 = <-60, 5, 40 + deslocamento>;
#declare posPai2 = <-60, 2, 31>;   
...
object {
  ...
  scale <4, 4, 4>
  rotate <0, 150, 0>
  translate <-55 + deslocamento, 8, 30 - deslocamento>  // deslocamento da vaca no eixo Z     
